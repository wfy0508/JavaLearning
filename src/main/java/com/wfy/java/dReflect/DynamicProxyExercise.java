...
public class DynamicProxyExercise {
    public static void main(String[] args) {
        // 小韭菜学生类
        Student1 ordinaryStudents = new OrdinaryStudents();
        ordinaryStudents.eat();
        ordinaryStudents.write();

        // 现在有一位特殊的学生，他是区长的儿子，我们自然要对他额外照顾，要给他加一下功能。
        // 一种思路是定义一个类：区长的儿子类，他继承自学生类，
        // 但世上儿子千千万，有区长的儿子，也有市长的儿子，更有省长的儿子，不能把他们挨个定义出来，
        ...
        // loader和interfaces基本就是决定了这个类到底是个怎么样的类。
        ...
        Student1 sonOfDistrict = (Student1) Proxy.newProxyInstance(
 ...
 * 小韭菜，能跑，能吃，能写作文。
 */
class OrdinaryStudents implements Student1 {
    @Override
    public void eat() {
